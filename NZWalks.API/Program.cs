...
builder.Services.AddIdentityCore<IdentityUser>(options => { /* opciones de Identity si es necesario */ })
    .AddRoles<IdentityRole>()
    .AddEntityFrameworkStores<NZWalksAuthDbContext>() // Esto registra IUserStore y RoleStore
    .AddSignInManager<SignInManager<IdentityUser>>() // Esto agrega el SignInManager
