...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20240812184545_InitialMigration'
)
BEGIN
...
BEGIN
    CREATE TABLE [Walks] (
        ...
        CONSTRAINT [FK_Walks_Difficulty_DifficultyId] FOREIGN KEY ([DifficultyId]) REFERENCES [Difficulty] ([Id]) ON DELETE CASCADE,
...
BEGIN
    ...
    VALUES (N'20240812184545_InitialMigration', N'8.0.8');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20240814041535_Seeding data'
)
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Name') AND [object_id] = OBJECT_ID(N'[Difficulty]'))
        SET IDENTITY_INSERT [Difficulty] ON;
    EXEC(N'INSERT INTO [Difficulty] ([Id], [Name])
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20240814041535_Seeding data', N'8.0.8');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20240816182218_Adding images table'
)
BEGIN
    CREATE TABLE [Images] (
        [Id] uniqueidentifier NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20240816182218_Adding images table', N'8.0.8');
END;
GO
